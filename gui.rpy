...
## 用于游戏内文本的字体。
define gui.text_font = "wqy-microhei.ttc"

## 用于角色名称的字体。
define gui.name_text_font = "wqy-microhei.ttc"

## 用于游戏外文本的字体。
define gui.interface_text_font = "wqy-microhei.ttc"
...
image sakura_small:
    ...
    alpha 0.6
    block:
        linear 2.0 rotate -40
        repeat

define sakura_small_fall = SnowBlossom("sakura_small", count=30, border=10, xspeed=(10, 30), yspeed=(60, 120))
define sakura_midium_fall = SnowBlossom("sakura_midium", count=20, border=10, xspeed=(20, 50), yspeed=(80, 180))
define sakura_big_fall = SnowBlossom("sakura_big", count=10, border=20, xspeed=(24, 60), yspeed=(120, 200))

define gui.main_menu_background = "gui/fengmian.png"
